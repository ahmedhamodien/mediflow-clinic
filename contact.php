            ...
            while ($current < $end) {
                ...
                if ($breakStart && $breakEnd) {
                    if ($current >= $breakStart && $current < $breakEnd) {
                        $isInBreak = true;
                        $current = clone $breakEnd; // Skip to after break
                        continue;
                    }
                }
            ...
            <form method="POST" action="" class="booking-form" id="bookingForm" <?php echo !$isLoggedIn ? 'style="display:none;"' : ''; ?>>
                ...
                <div class="booking-step" id="step2">
                    ...
                    <div class="time-slots-container" id="timeSlotsContainer">
                        ...
                        <p class="time-note" id="timeSlotNote">Please select a doctor and date first</p>
                        ...
                        <div id="selectedTimeDisplay" class="selected-time" style="display: none;">
                            <i class="fas fa-check-circle"></i>
                            <span>Selected time: <strong id="selectedTimeText"></strong></span>
                        </div>
                    </div>
